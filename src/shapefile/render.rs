        ...
        for shape_record in reader.iter_shapes_and_records() {
            ...
            if vectorconf.is_empty() {
                ...
                if luokka == "12316" && versuh != -11.0 {
                    thickness = 12.0;
                    dashedline = true;
                    image = Some(Image::Black);
                    color = Some(black);
                    if versuh > 0.0 {
                        image = Some(Image::BlackTop);
                    }
                }
